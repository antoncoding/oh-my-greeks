...
export const ETH: Token = {
  ...
  decimals: 18,
  img: require('../imgs/token-icons/ETH.png'),
  addresses: {
...
export const sBTC: Token = {
  ...
  decimals: 8,
  img: require('../imgs/token-icons/WBTC.png'),
  addresses: {
...
export const USDC: Token = {
  ...
  decimals: 6,
  img: require('../imgs/token-icons/USDC.png'),
  addresses: {
...
export const DAI: Token = {
  ...
  asset: UnderlyingAsset.USD,
  decimals: 18,
  img: require('../imgs/token-icons/DAI.png'),
  addresses: {
...
export const LINK: Token = {
  ...
  decimals: 18,
  img: require('../imgs/token-icons/LINK.png'),
  addresses: {
...
export const sLINK: Token = {
  ...
  asset: UnderlyingAsset.LINK,
  decimals: 18,
  img: require('../imgs/token-icons/sLINK.webp'),
  addresses: {
    [SupportedNetworks.Mainnet]: '0xbbc455cb4f1b9e4bfc4b73970d360c8f032efee6',
    [SupportedNetworks.OpKovan]: ZERO_ADDR,
